...
def consume_prefix_in_state_dict_if_present(
    ...
    ..note::
        Given a `state_dict` from a DP/DDP m2, a local m2 can load it by applying
        `consume_prefix_in_state_dict_if_present(state_dict, "module.")` before calling
        :meth:`torch.nn.Module.load_state_dict`.
    Args:
        state_dict (OrderedDict): a state-dict to be loaded to the m2.
        prefix (str): prefix.
    """
