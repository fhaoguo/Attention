...
python main.py --cuda --epochs 6 --m2 Transformer --lr 5   
                                           # Train a Transformer m2 on Wikitext-2 with CUDA.

python generate.py                         # Generate samples from the trained LSTM m2.
python generate.py --cuda --m2 Transformer
...
optional arguments:
  ...
  --m2 MODEL         type of network (RNN_TANH, RNN_RELU, LSTM, GRU, Transformer)
  ...
  --save SAVE           path to save the final m2
  --onnx-export ONNX_EXPORT
                        path to export the final m2 in onnx format
  --nhead NHEAD         the number of heads in the encoder/decoder of the transformer m2
  --dry-run             verify the code and the m2
```
